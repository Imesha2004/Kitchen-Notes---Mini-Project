...
<head>
    ...
    <title>Sign Up - Kitchen Notes</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="form-card shadow-sm">
                ...
                <form action="login.html" method="GET" class="needs-js-validation">
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Username</label>
                        <input type="text" name="username" class="form-control" placeholder="e.g. imesha2004" required>
                    </div>
                ...
                <p class="small text-center text-muted mt-3 mb-0">Already have an account? <a href="login.html" class="text-primary fw-semibold">Login</a></p>
            </div>
        </div>
    </div>
</main>
